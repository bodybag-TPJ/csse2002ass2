...
public class EagleSpawnerTest {
    ...
    public void testConstructorBasic() {
        EagleSpawner spawner = new EagleSpawner(100, 200);
    ...
    public void testConstructorWithDuration() {
        EagleSpawner spawner = new EagleSpawner(150, 250, 100);
    ...
    public void testGetX() {
        EagleSpawner spawner = new EagleSpawner(300, 400);
    ...
    public void testTickWhenNotFinished() {
        EagleSpawner spawner = new EagleSpawner(100, 200, 1000);
        MockEngineState engine = new MockEngineState(new TileGrid(25, 2000));
        TestGameState game = new TestGameState();
    ...
    public void testTickSetsSpawnCoordinates() {
        EagleSpawner spawner = new EagleSpawner(300, 400, 1);
        MockEngineState engine = new MockEngineState(new TileGrid(25, 2000));
        TestGameState game = new TestGameState();
    ...
    public void testGetXReturnsNonZero() {
        EagleSpawner spawner = new EagleSpawner(500, 600);
        int x = spawner.getX();
